...
#[AsCommand(
    name: 'app:sync:registrations',
    description: 'Synchronize training registrations from Rise Up into the local TrackUp database.',
)]
class SyncTrainingRegistrationsCommand extends Command
{
    public function __construct(private readonly TrainingRegistrationSyncService $trainingRegistrationSyncService)
    {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success('Training registration sync completed.');
        $io->definitionList(
